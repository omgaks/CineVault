...
/*
 * CineVault-specific Whisper Base INT8 config.
 * Model files are downloaded separately by WhisperModelManager.
 */
fun getWhisperBaseModelConfig(modelDir: String): OfflineModelConfig =
    OfflineModelConfig(
