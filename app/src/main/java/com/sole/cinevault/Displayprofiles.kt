...
// the tablet in landscape doesn't leak into how subtitles look on
// connected AR glasses, and vice versa. This EXTERNAL profile applies to
// any glasses that show up as a standard Presentation display — RayNeo,
// Viture, XREAL, Rokid, etc. — none of the profile logic is vendor-specific.
// Profiles are looked up and switched automatically — no manual "which
// profile am I on" picker: connecting any supported glasses switches to
// the EXTERNAL subtitle profile.
//
...
// profile is ever seen (nothing saved yet). The EXTERNAL (glasses)
// defaults specifically follow the spec: slightly smaller text, lower placement,
