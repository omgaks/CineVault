...
class PlayerMenuCloseCoordinatorTest {
    ...
    fun closeAllClosesEveryTransientPlayerSurface() {
        ...
        val coordinator = PlayerMenuCloseCoordinator(
            ...
            closeSpeechSubtitlePanel = { closed += "speech" },
            closeSubtitleTranslationPanel = { closed += "translation" },
            cancelDialogueSync = { closed += "dialogueSync" },
        ...
        assertEquals(
            listOf(
                ...
                "subtitleBehaviour", "speech", "translation", "dialogueSync",
                "subtitleSurfaces",
            ),
            closed,
        )
