...
fun BoxScope.SubtitleSyncAndAppearancePopups(
    ...
    onMarkPointA: (Boolean) -> Unit,
    onMarkPointB: (Boolean) -> Unit,
    onApplyDrift: () -> Unit,
    onDismissDrift: () -> Unit,
    ...
    onForegroundChange: (androidx.compose.ui.graphics.Color) -> Unit,
    onEdgeTypeChange: (Int) -> Unit,
    onEdgeColorChange: (androidx.compose.ui.graphics.Color) -> Unit,
    onBackgroundChange: (androidx.compose.ui.graphics.Color) -> Unit,
